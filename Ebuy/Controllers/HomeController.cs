...
namespace Ebuy.Controllers
{
    public class HomeController : AsyncController
    {
        ...
        public ActionResult Upload()
        {
            ...
            {
                using (var pic = new Bitmap(Request.Files[0].InputStream))
                {
                    EXIFextractor er = new EXIFextractor(pic, "\n");
                    var obj = er["Orientation"];
                    return Content(obj == null ? "" : obj.ToString());
                }
            }
    ...
    public class EXIFextractor : IEnumerable
    {
        ...
        /// <param name="sp"></param>  
        public EXIFextractor(System.Drawing.Bitmap bmp, string sp)
        {
